          ...
          {menuItems.map((item) => {
            ...
            return (
              <li key={item.id}>
                <Link
                  to={item.path}
                  className={`flex items-center space-x-3 px-3 py-2.5 rounded-lg transition-all duration-200 ${isItemActive
        ...
        <ul className="space-y-2">
          <li>
            <Link
              ...
              className={`flex items-center space-x-3 px-3 py-2.5 rounded-lg transition-all duration-200 ${isActive('/settings')
          ...
          <li>
            <button
              ...
              className={`w-full flex items-center space-x-3 px-3 py-2.5 rounded-lg text-slate-300 hover:bg-red-600 hover:text-white transition-all duration-200 ${isCollapsed ? 'justify-center' : ''
                }`}
